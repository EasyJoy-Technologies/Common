 ...
 */
public class QQSplashZoomOutManager {
    ...
    private static QQSplashZoomOutManager instance;

    public interface QQAnimationCallBack {
        void animationStart(int animationTime);

        void animationEnd();
    }

    public static QQSplashZoomOutManager getInstance(Context context) {
        if (instance == null) {
            synchronized (QQSplashZoomOutManager.class) {
                if (instance == null) {
                    instance = new QQSplashZoomOutManager(context);
                }
            }
        }
        return instance;
    ...
    private QQSplashZoomOutManager(Context context) {
    ...
    public ViewGroup startZoomOut(final ViewGroup animationContainer,
                                  ...
                                  final QQAnimationCallBack callBack) {
        ...
        QQViewUtils.removeFromParent(splashView);
    ...
    public ViewGroup startZoomOut(final View splash, final ViewGroup animationContainer,
        ...
        QQViewUtils.removeFromParent(splash);
